...
-- Optional backup of the actual epub/pdf file for a book, in case the user
-- only keeps the file itself on an e-reader. One file per book (UNIQUE
-- book_id): uploading a new one replaces the previous one.
