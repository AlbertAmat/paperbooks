...
- Un indicador de carga mientras se está buscando.
- Una marca verde en cuanto se ha añadido correctamente.
...
4. Haz clic en **Añadir**. Se te llevará directamente a la [página de detalle](#book-details) del nuevo libro para completar el resto — categoría, idioma, formato, autores y ejemplares físicos.

En cualquiera de los dos casos, una vez creado el libro llegarás a su página de detalle, lista para añadir stock e imprimir etiquetas.
