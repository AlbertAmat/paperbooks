/** Spanish translation of the Cookie Policy, rendered by LegalContent.vue. Content data only, edited by legal/product, not app logic. */
...
export const cookiePolicyEs: LegalBlock[] = [
    ...
    {
        type: "paragraph",
        text: "Esta Política de Cookies explica qué cookies utiliza Vaultisse (la \"Aplicación\") y con qué finalidad, de conformidad con la LSSI-CE (Ley de Servicios de la Sociedad de la Información) y el RGPD."
    },
    ...
    {type: "paragraph", text: "Vaultisse utiliza actualmente solo cookies técnicas o estrictamente necesarias:"},
    {
        type: "table",
    ...
    {
        type: "paragraph",
        text: "Vaultisse no utiliza actualmente cookies de análisis, publicidad o seguimiento de terceros. Si esto cambiara en el futuro, esta política se actualizará y, cuando sea necesario, se solicitará tu consentimiento antes de instalar dichas cookies."
    },
